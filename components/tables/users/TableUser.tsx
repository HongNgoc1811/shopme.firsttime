...
const columns = [
    ...
    {name: "AVATAR_URL", uid: "avatar_url", sortable: true},
...
export default function TableUser() {
            ...
            .on(
                ...
                (payload) => {
                    ...
                    if (payload.eventType === "INSERT") {
                        setListItems((prev) => [payload.new, ...prev]);
                    }
    ...
    return (
        <>
            ...
            <CreateUserModal isOpen={isOpen} onClose={() => onOpenChange()}/>
            <EditUserModal
                isOpen={isOpenEdit}
